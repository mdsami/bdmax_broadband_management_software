...
mysql_query("Update tblmember set Member_Name='$membername', Join_Date='$joindate', Member_ID='$memberid', Speed='$speed',Address='$address',Contact='$contact' where Member_ID='$memberid'");
