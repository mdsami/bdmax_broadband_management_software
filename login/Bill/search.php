...
$value1=$_POST['status'];
$value2=$_POST['month'];
	$sql="SELECT * FROM `tblbilling` where Status='$value1' and Month='$value2' order by Member_ID ASC";					// Sql Query to Select all Data from DB
 ...
 ?>
			...
			<form id="form1" name="search" method="post" action="search.php">
			  ...
			  <p>Month
				...
				<a href="Home.php">Add New Member</a>
