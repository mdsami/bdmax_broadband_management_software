...
$value=$_POST['memberid'];

	$sql="SELECT * FROM `tblbillingstore` where Member_ID='$value' order by Member_ID ASC";					// Sql Query to Select all Data from DB
...
if(mysql_num_rows($result))
 ...
 ?>
			...
			<form id="form1" name="search" method="post" action="searchpaidcustomer.php">
			  <label>Enter Member ID
				...
				<a href="viewer.php">Add New Member</a>
