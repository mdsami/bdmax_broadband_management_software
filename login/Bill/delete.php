...
?>
	...
	<form name="form1" method="post" action="delete_action.php"> 
		...
		<p>
		  Name:
		  <input type="text" name="Date" value="<?php echo $rows['Name']; ?>">

		</p>
		<p>Item: 

		  <input type="text" name="Date" value="<?php echo $rows['Item']; ?>">
	  <p>Cost 
	     <input type="text" name="Date" value="<?php echo $rows['Cost']; ?>">-->
